...
type ErrorResponse struct {
	...
	ErrorInfo CounterErrors `protobuf:"varint,1,opt,name=ErrorInfo,json=errorInfo,proto3,enum=counter.CounterErrors" json:"ErrorInfo,omitempty"`
}
...
type ArticleCountInfo struct {
	...
	Comment     uint64  `protobuf:"varint,1,opt,name=Comment,json=comment,proto3" json:"Comment,omitempty"`              // 评论次数
	Like        uint64  `protobuf:"varint,2,opt,name=Like,json=like,proto3" json:"Like,omitempty"`                       // 喜欢次数
	Collect     uint64  `protobuf:"varint,3,opt,name=Collect,json=collect,proto3" json:"Collect,omitempty"`              // 收藏次数
	DisLike     uint64  `protobuf:"varint,4,opt,name=DisLike,json=disLike,proto3" json:"DisLike,omitempty"`              // 不喜欢次数
	PageView    uint64  `protobuf:"varint,5,opt,name=PageView,json=pageView,proto3" json:"PageView,omitempty"`           // 浏览量
	RewardTimes uint64  `protobuf:"varint,6,opt,name=RewardTimes,json=rewardTimes,proto3" json:"RewardTimes,omitempty"`  // 打赏次数
	RewardTotal float64 `protobuf:"fixed64,7,opt,name=RewardTotal,json=rewardTotal,proto3" json:"RewardTotal,omitempty"` // 打赏总金额
}
...
type UserCountInfo struct {
	...
	Articles    uint64  `protobuf:"varint,1,opt,name=Articles,json=articles,proto3" json:"Articles,omitempty"`           // 文章个数
	Comments    uint64  `protobuf:"varint,2,opt,name=Comments,json=comments,proto3" json:"Comments,omitempty"`           // 评论个数
	Commented   uint64  `protobuf:"varint,3,opt,name=Commented,json=commented,proto3" json:"Commented,omitempty"`        // 被评论个数
	RewardTimes uint64  `protobuf:"varint,4,opt,name=RewardTimes,json=rewardTimes,proto3" json:"RewardTimes,omitempty"`  // 打赏次数
	RewardTotal float64 `protobuf:"fixed64,5,opt,name=RewardTotal,json=rewardTotal,proto3" json:"RewardTotal,omitempty"` // 打赏总金额
}
...
type UpdateRequest struct {
	...
	Field string `protobuf:"bytes,1,opt,name=Field,json=field,proto3" json:"Field,omitempty"` // 字段
	Value string `protobuf:"bytes,2,opt,name=Value,json=value,proto3" json:"Value,omitempty"` // 字段加减值
	ID    uint64 `protobuf:"varint,3,opt,name=ID,json=iD,proto3" json:"ID,omitempty"`         // 请求资源ID
}
...
var file_counter_counter_proto_rawDesc = []byte{
	...
	0x52, 0x09, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0xd4, 0x01, 0x0a, 0x10,
	...
	,
	...
	,
	...
	0x66, 0x69, 0x65, 0x6c, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x49,
	0x44, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x44, 0x2a, 0x2e, 0x0a, 0x0d, 0x43,
