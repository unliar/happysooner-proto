...
var file_account_account_proto_rawDesc = []byte{
	...
	0x2a, 0x3a, 0x0a, 0x04, 0x52, 0x6f, 0x6c, 0x65, 0x12, 0x0f, 0x0a, 0x0b, 0x44, 0x65, 0x66, 0x61,
	0x75, 0x6c, 0x74, 0x52, 0x6f, 0x6c, 0x65, 0x10, 0x00, 0x12, 0x09, 0x0a, 0x05, 0x41, 0x64, 0x6d,
	0x69, 0x6e, 0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x10, 0x02,
	0x12, 0x0a, 0x0a, 0x06, 0x56, 0x69, 0x65, 0x77, 0x65, 0x72, 0x10, 0x03, 0x2a, 0xc5, 0x02, 0x0a,
	...
	0x10, 0xcb, 0x84, 0x3d, 0x32, 0xd6, 0x0e, 0x0a, 0x09, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	...
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e,
	0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x62, 0x06, 0x70,
...
var file_account_account_proto_depIdxs = []int32{
	...
	2,  // 34: account.AccountSV.GetUserInfo:output_type -> account.UserInfo
	3,  // 35: account.AccountSV.GetUsersInfoByIDS:output_type -> account.UserInfoList
	2,  // 36: account.AccountSV.GetUserInfoByToken:output_type -> account.UserInfo
	9,  // 37: account.AccountSV.CreateUserInfoByLoginName:output_type -> account.ErrorResponse
	5,  // 38: account.AccountSV.GetUserToken:output_type -> account.UserInfoWithToken
	9,  // 39: account.AccountSV.CheckNickname:output_type -> account.ErrorResponse
	9,  // 40: account.AccountSV.CheckPhone:output_type -> account.ErrorResponse
	9,  // 41: account.AccountSV.CheckEmail:output_type -> account.ErrorResponse
	9,  // 42: account.AccountSV.CheckLoginName:output_type -> account.ErrorResponse
	9,  // 43: account.AccountSV.PutUserPassword:output_type -> account.ErrorResponse
	9,  // 44: account.AccountSV.PutUserBaseInfo:output_type -> account.ErrorResponse
	5,  // 45: account.AccountSV.GetUserTokenByOauthCode:output_type -> account.UserInfoWithToken
	14, // 46: account.AccountSV.GetUserPasswordRandomStatus:output_type -> account.PasswordRandomStatus
	9,  // 47: account.AccountSV.BindUserContactEmail:output_type -> account.ErrorResponse
	9,  // 48: account.AccountSV.BindUserContactPhone:output_type -> account.ErrorResponse
	17, // 49: account.AccountSV.GetUserContactInfo:output_type -> account.UserContact
	22, // 50: account.AccountSV.GetUserNewRoles:output_type -> account.NewRoleList
	24, // 51: account.AccountSV.GetUserPermissions:output_type -> account.PermissionInfoList
	9,  // 52: account.AccountSV.SetUserRole:output_type -> account.ErrorResponse
	9,  // 53: account.AccountSV.DelUserRole:output_type -> account.ErrorResponse
	9,  // 54: account.AccountSV.PostNewRole:output_type -> account.ErrorResponse
	9,  // 55: account.AccountSV.PutNewRole:output_type -> account.ErrorResponse
	9,  // 56: account.AccountSV.DelNewRole:output_type -> account.ErrorResponse
	22, // 57: account.AccountSV.GetNewRoles:output_type -> account.NewRoleList
	6,  // 58: account.AccountSV.GetUserUID:output_type -> account.UIDInput
	9,  // 59: account.AccountSV.GetVaptchaVerify:output_type -> account.ErrorResponse
	9,  // 60: account.AccountSV.GetVaptchaOfflineVerify:output_type -> account.ErrorResponse
