...
type PayWay struct {
	...
	PayWayID int64  `protobuf:"varint,1,opt,name=PayWayID,json=payWayID,proto3" json:"PayWayID,omitempty"` // 用户支付id
	PayType  string `protobuf:"bytes,2,opt,name=PayType,json=payType,proto3" json:"PayType,omitempty"`     // 支付类型
	PayValue string `protobuf:"bytes,3,opt,name=PayValue,json=payValue,proto3" json:"PayValue,omitempty"`  // 支付链接
	PayDesc  string `protobuf:"bytes,4,opt,name=PayDesc,json=payDesc,proto3" json:"PayDesc,omitempty"`     // 支付描述
}
...
type CreateUserPayWayRequest struct {
	...
	PayType  string `protobuf:"bytes,1,opt,name=PayType,json=payType,proto3" json:"PayType,omitempty"`    // 支付类型
	PayValue string `protobuf:"bytes,2,opt,name=PayValue,json=payValue,proto3" json:"PayValue,omitempty"` // 支付链接
	PayDesc  string `protobuf:"bytes,3,opt,name=PayDesc,json=payDesc,proto3" json:"PayDesc,omitempty"`    // 支付描述
	UID      int64  `protobuf:"varint,4,opt,name=UID,json=uID,proto3" json:"UID,omitempty"`               // 用户id
}
...
type DeleteUserPayWayRequest struct {
	...
	PayWayID int64 `protobuf:"varint,2,opt,name=PayWayID,json=payWayID,proto3" json:"PayWayID,omitempty"` // 用户支付id
}
...
type PutUserPayWayRequest struct {
	...
	UID      int64  `protobuf:"varint,1,opt,name=UID,json=uID,proto3" json:"UID,omitempty"`                // 用户id
	PayWayID int64  `protobuf:"varint,2,opt,name=PayWayID,json=payWayID,proto3" json:"PayWayID,omitempty"` // 用户支付id
	PayType  string `protobuf:"bytes,3,opt,name=PayType,json=payType,proto3" json:"PayType,omitempty"`     // 支付类型
	PayValue string `protobuf:"bytes,4,opt,name=PayValue,json=payValue,proto3" json:"PayValue,omitempty"`  // 支付链接
	PayDesc  string `protobuf:"bytes,5,opt,name=PayDesc,json=payDesc,proto3" json:"PayDesc,omitempty"`     // 支付描述
}
...
type UserPayWays struct {
	...
	PayWays []*PayWay `protobuf:"bytes,1,rep,name=PayWays,json=payWays,proto3" json:"PayWays,omitempty"` // 支付方式
}
...
type ErrorResponse struct {
	...
	ErrorInfo PayErrors `protobuf:"varint,1,opt,name=ErrorInfo,json=errorInfo,proto3,enum=pay.PayErrors" json:"ErrorInfo,omitempty"` // 错误信息
}
...
type CreateOrderCommonRequest struct {
	...
	CreateUserID      int64  `protobuf:"varint,1,opt,name=CreateUserID,json=createUserID,proto3" json:"CreateUserID,omitempty"`               // 创建订单用户ID
	OrderType         string `protobuf:"bytes,2,opt,name=OrderType,json=orderType,proto3" json:"OrderType,omitempty"`                         // 创建订单的类型 = article
	CreateForUserID   int64  `protobuf:"varint,3,opt,name=CreateForUserID,json=createForUserID,proto3" json:"CreateForUserID,omitempty"`      // 当前订单是为谁创建的 不传的话默认是1号用户 也就是可爱的管理员同志
	TotalAmount       string `protobuf:"bytes,4,opt,name=TotalAmount,json=totalAmount,proto3" json:"TotalAmount,omitempty"`                   // 订单总金额 金额默认是字符串 1.11 人民币
	Subject           string `protobuf:"bytes,5,opt,name=Subject,json=subject,proto3" json:"Subject,omitempty"`                               // 订单标题
	OrderExtends      string `protobuf:"bytes,6,opt,name=OrderExtends,json=orderExtends,proto3" json:"OrderExtends,omitempty"`                // 订单额外参数 对应的是订单类型的value
	OrderPlatform     string `protobuf:"bytes,7,opt,name=OrderPlatform,json=orderPlatform,proto3" json:"OrderPlatform,omitempty"`             // 订单平台 alipay = 支付宝支付  wxpay = 微信支付
	OrderPlatformMode string `protobuf:"bytes,8,opt,name=OrderPlatformMode,json=orderPlatformMode,proto3" json:"OrderPlatformMode,omitempty"` // 订单平台的支付模式 alipay = 当面付 alipayweb = 电脑网站支付  alipaywap = 手机网站支付
	QuitURL           string `protobuf:"bytes,9,opt,name=QuitURL,json=quitURL,proto3" json:"QuitURL,omitempty"`                               // 支付宝 wap支付订单退出页面
	ReturnURL         string `protobuf:"bytes,10,opt,name=ReturnURL,json=returnURL,proto3" json:"ReturnURL,omitempty"`                        // 支付宝 wap支付订单成功支付页面
	OpenID            string `protobuf:"bytes,11,opt,name=OpenID,json=openID,proto3" json:"OpenID,omitempty"`                                 // 用户识别ID          【微信jsapi必传】 必传
	ClientIP          string `protobuf:"bytes,12,opt,name=ClientIP,json=clientIP,proto3" json:"ClientIP,omitempty"`                           // 创建订单的客户端IP   【微信必传】
}
...
type PayOrderResultRequest struct {
	...
	OutTradeNo string `protobuf:"bytes,1,opt,name=OutTradeNo,json=outTradeNo,proto3" json:"OutTradeNo,omitempty"` // 商户的订单号
	Status     string `protobuf:"bytes,2,opt,name=Status,json=status,proto3" json:"Status,omitempty"`             // 订单状态 wait_pay trade_success trade_close trade_done
	RawData    string `protobuf:"bytes,3,opt,name=RawData,json=rawData,proto3" json:"RawData,omitempty"`          // 回调的原始参数表单参数
}
...
type OrderResultResponse struct {
	...
	Code         string `protobuf:"bytes,1,opt,name=Code,json=code,proto3" json:"Code,omitempty"`                         // 错误代码
	Msg          string `protobuf:"bytes,2,opt,name=Msg,json=msg,proto3" json:"Msg,omitempty"`                            // 错误信息
	OutTradeNo   string `protobuf:"bytes,3,opt,name=OutTradeNo,json=outTradeNo,proto3" json:"OutTradeNo,omitempty"`       // 商户的订单号
	QRCode       string `protobuf:"bytes,4,opt,name=QRCode,json=qRCode,proto3" json:"QRCode,omitempty"`                   // 订单的二维码链接
	Sign         string `protobuf:"bytes,5,opt,name=Sign,json=sign,proto3" json:"Sign,omitempty"`                         // 签名
	TradeStatus  string `protobuf:"bytes,6,opt,name=TradeStatus,json=tradeStatus,proto3" json:"TradeStatus,omitempty"`    // 交易状态
	TradeNo      string `protobuf:"bytes,7,opt,name=TradeNo,json=tradeNo,proto3" json:"TradeNo,omitempty"`                // 支付宝交易号
	TotalAmount  string `protobuf:"bytes,8,opt,name=TotalAmount,json=totalAmount,proto3" json:"TotalAmount,omitempty"`    // 订单总金额
	BuyerLogonID string `protobuf:"bytes,9,opt,name=BuyerLogonID,json=buyerLogonID,proto3" json:"BuyerLogonID,omitempty"` // 用户支付宝ID
}
...
type GetOrderListRequest struct {
	...
	OrderCreateByUID  string `protobuf:"bytes,1,opt,name=OrderCreateByUID,json=orderCreateByUID,proto3" json:"OrderCreateByUID,omitempty"`    // 创建订单用户ID
	OrderType         string `protobuf:"bytes,2,opt,name=OrderType,json=orderType,proto3" json:"OrderType,omitempty"`                         // 创建订单的类型 , 当前只有打赏类型
	OrdercreateForUID string `protobuf:"bytes,3,opt,name=OrdercreateForUID,json=ordercreateForUID,proto3" json:"OrdercreateForUID,omitempty"` // 当前订单是为谁创建的 不传的话默认是1号用户 也就是可爱的管理员同志
	Page              int64  `protobuf:"varint,4,opt,name=Page,json=page,proto3" json:"Page,omitempty"`                                       // 页码
	Size              int64  `protobuf:"varint,5,opt,name=Size,json=size,proto3" json:"Size,omitempty"`                                       // 数量
	Status            string `protobuf:"bytes,6,opt,name=Status,json=status,proto3" json:"Status,omitempty"`                                  // 订单状态
	OrderPlatForm     string `protobuf:"bytes,7,opt,name=OrderPlatForm,json=orderPlatForm,proto3" json:"OrderPlatForm,omitempty"`             // 平台
	OrderExtends      string `protobuf:"bytes,9,opt,name=OrderExtends,json=orderExtends,proto3" json:"OrderExtends,omitempty"`                // 订单扩展字段
}
...
type OrderInfo struct {
	...
	OutTradeNo   string `protobuf:"bytes,1,opt,name=OutTradeNo,json=outTradeNo,proto3" json:"OutTradeNo,omitempty"`        //　商户的订单号
	Status       string `protobuf:"bytes,2,opt,name=Status,json=status,proto3" json:"Status,omitempty"`                    //  订单状态
	PlatForm     string `protobuf:"bytes,3,opt,name=PlatForm,json=platForm,proto3" json:"PlatForm,omitempty"`              //  订单的平台
	Type         string `protobuf:"bytes,4,opt,name=Type,json=type,proto3" json:"Type,omitempty"`                          //  订单的类型
	CreateByUID  string `protobuf:"bytes,5,opt,name=CreateByUID,json=createByUID,proto3" json:"CreateByUID,omitempty"`     //  订单创建人
	CreateForUID string `protobuf:"bytes,6,opt,name=CreateForUID,json=createForUID,proto3" json:"CreateForUID,omitempty"`  //  订单创建对象人
	Extends      string `protobuf:"bytes,7,opt,name=Extends,json=extends,proto3" json:"Extends,omitempty"`                 //  订单扩展
	Amount       string `protobuf:"bytes,8,opt,name=Amount,json=amount,proto3" json:"Amount,omitempty"`                    //  订单金额
	CreatedAt    int64  `protobuf:"varint,9,opt,name=CreatedAt,json=createdAt,proto3" json:"CreatedAt,omitempty"`          //  订单创建时间
	Expired      bool   `protobuf:"varint,10,opt,name=Expired,json=expired,proto3" json:"Expired,omitempty"`               //  订单是否失效 - 目前是90分钟
	QRCode       string `protobuf:"bytes,11,opt,name=QRCode,json=qRCode,proto3" json:"QRCode,omitempty"`                   //  订单的二维码
	PlatFormMode string `protobuf:"bytes,12,opt,name=PlatFormMode,json=platFormMode,proto3" json:"PlatFormMode,omitempty"` //  订单平台的模式
}
...
type OrderListResponse struct {
	...
	List []*OrderInfo `protobuf:"bytes,1,rep,name=List,json=list,proto3" json:"List,omitempty"` // 订单列表
}
...
type GetSponsorsRequest struct {
	...
	Type         string `protobuf:"bytes,1,opt,name=Type,json=type,proto3" json:"Type,omitempty"`                         //  订单的类型
	CreateByUID  string `protobuf:"bytes,2,opt,name=CreateByUID,json=createByUID,proto3" json:"CreateByUID,omitempty"`    //  订单创建人
	CreateForUID string `protobuf:"bytes,3,opt,name=CreateForUID,json=createForUID,proto3" json:"CreateForUID,omitempty"` //  创建对象
	Extends      string `protobuf:"bytes,4,opt,name=Extends,json=extends,proto3" json:"Extends,omitempty"`                //  类型对应扩展值
}
...
type StringList struct {
	...
	List []string `protobuf:"bytes,1,rep,name=List,json=list,proto3" json:"List,omitempty"` // 数值列表
}
...
var file_pay_pay_proto_rawDesc = []byte{
	...
	0x12, 0x10, 0x0a, 0x03, 0x55, 0x49, 0x44, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x75,
	...
	0x70, 0x61, 0x79, 0x57, 0x61, 0x79, 0x49, 0x44, 0x12, 0x18, 0x0a, 0x07, 0x50, 0x61, 0x79, 0x54,
	0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x61, 0x79, 0x54, 0x79,
	0x70, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x50, 0x61, 0x79, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x61, 0x79, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x18,
	0x0a, 0x07, 0x50, 0x61, 0x79, 0x44, 0x65, 0x73, 0x63, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x07, 0x70, 0x61, 0x79, 0x44, 0x65, 0x73, 0x63, 0x22, 0x7b, 0x0a, 0x17, 0x43, 0x72, 0x65, 0x61,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x61, 0x79, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1a, 0x0a,
	0x08, 0x50, 0x61, 0x79, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x08, 0x70, 0x61, 0x79, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x50, 0x61, 0x79,
	0x44, 0x65, 0x73, 0x63, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x61, 0x79, 0x44,
	0x65, 0x73, 0x63, 0x12, 0x10, 0x0a, 0x03, 0x55, 0x49, 0x44, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x03, 0x75, 0x49, 0x44, 0x22, 0x47, 0x0a, 0x17, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x55,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x70, 0x61, 0x79, 0x57, 0x61, 0x79, 0x49, 0x44, 0x22, 0x94,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x75, 0x49, 0x44, 0x12, 0x1a, 0x0a, 0x08, 0x50, 0x61, 0x79,
	0x57, 0x61, 0x79, 0x49, 0x44, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x70, 0x61, 0x79,
	0x57, 0x61, 0x79, 0x49, 0x44, 0x12, 0x18, 0x0a, 0x07, 0x50, 0x61, 0x79, 0x54, 0x79, 0x70, 0x65,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x61, 0x79, 0x54, 0x79, 0x70, 0x65, 0x12,
	0x1a, 0x0a, 0x08, 0x50, 0x61, 0x79, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x08, 0x70, 0x61, 0x79, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x50,
	0x61, 0x79, 0x44, 0x65, 0x73, 0x63, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x61,
	...
	0x61, 0x79, 0x52, 0x07, 0x70, 0x61, 0x79, 0x57, 0x61, 0x79, 0x73, 0x22, 0x3d, 0x0a, 0x0d, 0x45,
	...
	0x09, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0xa6, 0x03, 0x0a, 0x18, 0x43,
	...
	0x65, 0x55, 0x73, 0x65, 0x72, 0x49, 0x44, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c, 0x63,
	...
	0x6f, 0x72, 0x64, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x12, 0x28, 0x0a, 0x0f, 0x43, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x46, 0x6f, 0x72, 0x55, 0x73, 0x65, 0x72, 0x49, 0x44, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x0f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x46, 0x6f, 0x72, 0x55, 0x73, 0x65,
	...
	0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x45, 0x78, 0x74, 0x65,
	0x6e, 0x64, 0x73, 0x12, 0x24, 0x0a, 0x0d, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x50, 0x6c, 0x61, 0x74,
	0x66, 0x6f, 0x72, 0x6d, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x6f, 0x72, 0x64, 0x65,
	...
	,
	...
	0x52, 0x0a, 0x6f, 0x75, 0x74, 0x54, 0x72, 0x61, 0x64, 0x65, 0x4e, 0x6f, 0x12, 0x16, 0x0a, 0x06,
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x52, 0x61, 0x77, 0x44, 0x61, 0x74, 0x61, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x72, 0x61, 0x77, 0x44, 0x61, 0x74, 0x61, 0x22, 0x89,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x4d, 0x73,
	...
	0x52, 0x0a, 0x6f, 0x75, 0x74, 0x54, 0x72, 0x61, 0x64, 0x65, 0x4e, 0x6f, 0x12, 0x16, 0x0a, 0x06,
	0x51, 0x52, 0x43, 0x6f, 0x64, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x71, 0x52,
	0x43, 0x6f, 0x64, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x53, 0x69, 0x67, 0x6e, 0x18, 0x05, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x04, 0x73, 0x69, 0x67, 0x6e, 0x12, 0x20, 0x0a, 0x0b, 0x54, 0x72, 0x61, 0x64,
	0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x74,
	0x72, 0x61, 0x64, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x54, 0x72,
	0x61, 0x64, 0x65, 0x4e, 0x6f, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x74, 0x72, 0x61,
	...
	0x6f, 0x67, 0x6f, 0x6e, 0x49, 0x44, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x62, 0x75,
	...
	0x65, 0x42, 0x79, 0x55, 0x49, 0x44, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x6f, 0x72,
	...
	,
	...
	,
	...
	0x08, 0x52, 0x07, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x51, 0x52,
	0x43, 0x6f, 0x64, 0x65, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x71, 0x52, 0x43, 0x6f,
	0x64, 0x65, 0x12, 0x22, 0x0a, 0x0c, 0x50, 0x6c, 0x61, 0x74, 0x46, 0x6f, 0x72, 0x6d, 0x4d, 0x6f,
	0x64, 0x65, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x70, 0x6c, 0x61, 0x74, 0x46, 0x6f,
	...
	0x09, 0x52, 0x07, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x64, 0x73, 0x22, 0x20, 0x0a, 0x0a, 0x53, 0x74,
	0x72, 0x69, 0x6e, 0x67, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x4c, 0x69, 0x73, 0x74,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x2a, 0x7a, 0x0a, 0x09,
