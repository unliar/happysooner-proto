...
type CreateOrderCommonRequest struct {
	...
	OrderPlatformMode string `protobuf:"bytes,8,opt,name=OrderPlatformMode,proto3" json:"OrderPlatformMode,omitempty"` // 订单平台的支付模式 alipay = 当面付 alipayweb
...
var file_pay_pay_proto_rawDesc = []byte{
	...
	0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x0b, 0x5a, 0x09, 0x2e,
	0x2f, 0x70, 0x61, 0x79, 0x3b, 0x70, 0x61, 0x79, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
