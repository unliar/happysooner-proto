...
type PostFileRequest struct {
	...
	Data          string `protobuf:"bytes,1,opt,name=Data,json=data,proto3" json:"Data,omitempty"`                            // 数据
	FileName      string `protobuf:"bytes,2,opt,name=FileName,json=fileName,proto3" json:"FileName,omitempty"`                // 文件名  111
	FileExtension string `protobuf:"bytes,3,opt,name=FileExtension,json=fileExtension,proto3" json:"FileExtension,omitempty"` // 文件类型 jpg
}
...
type PostFileResponse struct {
	...
	FileURL string `protobuf:"bytes,1,opt,name=FileURL,json=fileURL,proto3" json:"FileURL,omitempty"` // 资源地址
}
...
var file_file_file_proto_rawDesc = []byte{
	...
	0x52, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x24, 0x0a, 0x0d, 0x46, 0x69,
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x66, 0x69, 0x6c, 0x65, 0x55, 0x52, 0x4c, 0x32, 0x46,
